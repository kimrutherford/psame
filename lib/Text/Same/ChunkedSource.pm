...
=head2 get_all_chunks
 ...
 Usage   : $all_chunks = $chunk->get_all_chunks();
...
=head2 get_filtered_chunks
 ...
 Usage   : $filtered_chunks = $chunk->get_filtered_chunks($options);
...
=head2 get_matching_chunks
 ...
 Usage   : $matching_chunks = $chunk->get_matching_chunks($options, $text);
 Function: return (in order) the chunks from this source that match the given
           text.
           options:
            ignore_case=> (0 or 1)    -- ignore case when comparing
...
=head2 get_filtered_indx_from_real
 ...
 Usage   : $indx = $chunk->get_filtered_indx_from_real($options, $real_indx);
...
=head2 get_real_indx_from_filtered
 ...
 Usage : $indx = $chunk->get_real_indx_from_filtered($options, $filtered_indx);
...
=head2 get_previous_chunk
 ...
 Usage   : $prev_chunk = $chunk->get_previous_chunk($options, $chunk);
